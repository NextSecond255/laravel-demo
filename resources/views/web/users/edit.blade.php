                        ...
                        <form method="POST" action="{{ route('users.update', Auth::id()) }}"
                            ...
                            <div class="form-group row">
                                <label for="name-field"
                                       class="col-sm-4 col-form-label text-md-right">用&ensp;户&ensp;名</label>
                            ...
                            <div class="form-group row">
                                <label for="email-field"
                                       class="col-sm-4 col-form-label text-md-right">邮&emsp;&emsp;箱</label>
                            ...
                            <div class="form-group row">
                                <label for="introduction-field"
                                       class="col-md-4 col-form-label text-md-right">个人简介</label>
