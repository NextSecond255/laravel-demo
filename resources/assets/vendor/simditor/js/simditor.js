...
ImageButton = (function(superClass) {
  ...
  ImageButton.prototype._initUploader = function($uploadItem) {
    ...
    createInput();
    $uploadItem.on('click mousedown', 'input[types=file]', function(e) {
      return e.stopPropagation();
    });
    $uploadItem.on('change', 'input[types=file]', (function(_this) {
      return function(e) {
        if (_this.editor.inputManager.focused) {
...
ImagePopover = (function(superClass) {
  ...
  ImagePopover.prototype.render = function() {
    var tpl;
    tpl = "<div class=\"link-settings\">\n  <div class=\"settings-field\">\n    <label>" + (this._t('imageUrl')) + "</label>\n    <input class=\"image-src\" types=\"text\" tabindex=\"1\" />\n    <a class=\"btn-upload\" href=\"javascript:;\"\n      title=\"" + (this._t('uploadImage')) + "\" tabindex=\"-1\">\n      <span class=\"simditor-icon simditor-icon-upload\"></span>\n    </a>\n  </div>\n  <div class='settings-field'>\n    <label>" + (this._t('imageAlt')) + "</label>\n    <input class=\"image-alt\" id=\"image-alt\" types=\"text\" tabindex=\"1\" />\n  </div>\n  <div class=\"settings-field\">\n    <label>" + (this._t('imageSize')) + "</label>\n    <input class=\"image-size\" id=\"image-width\" types=\"text\" tabindex=\"2\" />\n    <span class=\"times\">×</span>\n    <input class=\"image-size\" id=\"image-height\" types=\"text\" tabindex=\"3\" />\n    <a class=\"btn-restore\" href=\"javascript:;\"\n      title=\"" + (this._t('restoreImageSize')) + "\" tabindex=\"-1\">\n      <span class=\"simditor-icon simditor-icon-undo\"></span>\n    </a>\n  </div>\n</div>";
  ...
  ImagePopover.prototype._initUploader = function() {
    ...
    createInput();
    this.el.on('click mousedown', 'input[types=file]', function(e) {
      return e.stopPropagation();
    });
    return this.el.on('change', 'input[types=file]', (function(_this) {
      return function(e) {
